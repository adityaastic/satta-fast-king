...
const AdvertisementComponent = ({ type }) => {
  ...
  // Slice the arrays to only include the first 6 items
  const oddAddSliced = oddAdd.slice(3, 4);
  const evenAddSliced = evenAdd.slice(5, 6);
  const randomAddSliced = randomAdd.slice(7,8);

  return (
    <div className="advertisementSection">
      {type === "odd" && (
        <div className="row">
          {oddAddSliced.length > 0 ? (
            oddAddSliced.map((odd, index) => (
              <div key={index} className="col-md-12 ad-section">
                <div className="col-lg-12">
                  <h3>name: {odd?.name}</h3>
                  <h6
      ...
      {type === "even" && (
        <div className="row">
          {evenAddSliced.length > 0 ? (
            evenAddSliced.map((even, index) => (
              <div key={index} className="col-am-12 ad-section">
                <div className="col-lg-12">
                  <h3>name: {even?.name}</h3>
                  <h6
      ...
      {type === "random" && (
        <div className="row">
          {randomAddSliced.length > 0 ? (
            randomAddSliced.map((random, index) => (
              <div key={index} className="col-am-12 ad-section">
                <div className="col-lg-12">
                  <h3>name: {random?.name}</h3>
                  <h6
